...
<div id="wrapper">
    ...
    <div id="page-wrapper" style="margin-top:5%;">
        <div class="row">
            ...
            <div class="col-lg-12">
                <h1 class="page-header">Detail záznamu firmy:</h1>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <b>FIRMA</b>
                                <a href="<?php echo site_url('firmy'); ?>" class="pull-right">
                            ...
                            <div class="panel-body">
                                <div class="form-group"><label><b>Názov firmy:</b></label>
                                    <p>
                                        <?php echo !empty($firmy['Nazov']) ? $firmy['Nazov'] : ''; ?>
                                    </p>
                                </div>
                                <div class="form-group"><label><b>Adresa:</b></label>
                                    <p>
                                        <?php echo !empty($firmy['Adresa']) ? $firmy['Adresa'] : ''; ?>
                                    </p>
                                </div>
                                ...
                                <div class="form-group"><label><b>E-mail:</b></label>
                                    <p>
                                        <?php echo !empty($firmy['Email']) ? $firmy['Email'] : ''; ?>
                                    </p>
                                </div>
                            </div>
