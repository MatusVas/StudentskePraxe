...
<head>
    ...
    <title>Študentská prax - Firmy</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="panel-heading">
                    <h2>Firmy, ktoré ponúkajú prax pre študentov:</h2>
                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="panel panel-default ">
                                    ...
                                    <div class="panel-heading">
                                        <b>FIRMY</b>
                                        <a href="<?php echo site_url('firmy/add'); ?>" class="pull-right" title="Pridať záznam">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody id="userData">
                                        <?php if (!empty($firmy)): foreach ($firmy as $Firmy): ?>
                                            <tr>
                                                <td>
                                                    <?php echo '#' . $Firmy->idFirmy; ?>
                                                </td>
                                                <td>
                                                    <?php echo $Firmy->Nazov; ?>
                                                </td>
                                                <td>
                                                    <?php echo $Firmy->Adresa; ?>
                                                </td>
                                                <td><?php echo $Firmy->Mesto; ?>
                                                </td>
                                                <td>
                                                    <?php echo $Firmy->Telefon; ?>
                                                </td>
                                                <td>
                                                    <?php echo $Firmy->Email; ?>
                                                </td>
                                                <td>
                                                    <a href="<?php echo site_url('firmy/view/' . $Firmy->idFirmy); ?>" title="Detail záznamu">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="<?php echo site_url('firmy/edit/' . $Firmy->idFirmy); ?>" title="Editovať záznam">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                    <a href="<?php echo site_url('firmy/delete/' . $Firmy->idFirmy); ?>"
