...
<div id="wrapper">
    ...
    <div id="page-wrapper" style="margin-top:5%;">
        <div class="row">
            ...
            <div class="col-lg-12">
                <h1 class="page-header">Pridanie/edit firmy:</h1>
                            ...
                            <div class="panel-body">
                                <form method="post" action="" class="form">
                                    <div class="form-group">
                                        <label for="title"><b>Názov firmy:</b></label>
                                        <input type="text" class="form-control" name="Nazov" placeholder="Zadajte názov firmy"
