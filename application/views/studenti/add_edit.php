...
<div id="wrapper">
    ...
    <div id="page-wrapper" style="margin-top:5%;">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Pridanie/edit študenta:</h1>
                            ...
                            <div class="panel-body">
                                <form method="post" action="" class="form">
                                    ...
                                    <div class="form-group">
                                        <?php echo form_label('Názov školy:'); ?>
                                        <?php echo form_dropdown('idSkoly', $skoly, $skola_selected, 'class="form-control"'); ?>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="title"><b>Rok narodenia:</b></label>
                                        <input type="text" class="form-control" name="Rok_narodenia" placeholder="YYYY-MM-DD"
                                               value="<?php echo !empty($post['Rok_narodenia']) ? $post['Rok_narodenia'] : ''; ?>">
                                        <?php echo form_error('Rok_narodenia', '<p class="help-block text-danger">', '</p>'); ?>
                                    </div>
