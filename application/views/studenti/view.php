...
<div id="wrapper">
    ...
    <div id="page-wrapper" style="margin-top:5%;">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h1 class="page-header">Detail záznamu študenta:</h1>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <b>ŠTUDENT</b>
                                <a href="<?php echo site_url('studenti'); ?>" class="pull-right">
                            ...
                            <div class="panel-body">
                                <div class="form-group"><label><b>Názov školy:</b></label>
                                    <p>
                                        <?php echo !empty($studenti['Nazov']) ? $studenti['Nazov'] : ''; ?>
                                    </p>
                                </div>
                                <div class="form-group"><label><b>Študent:</b></label>
                                    <p>
                                        <?php echo !empty($studenti['fullname']) ? $studenti['fullname'] : ''; ?>
                                    </p>
                                </div>
                                <div class="form-group"><label><b>Rok narodenia:</b></label>
                                    <p>
                                        <?php echo !empty($studenti['Rok_narodenia']) ? $studenti['Rok_narodenia'] : ''; ?>
                                    </p>
                                </div>
                                <div class="form-group"><label><b>Adresa:</b></label>
                                    <p>
                                        <?php echo !empty($studenti['Adresa']) ? $studenti['Adresa'] : ''; ?>
                                    </p>
                                </div>
                                <div class="form-group"><label><b>Mesto:</b></label>
                                    <p>
                                        <?php echo !empty($studenti['Mesto']) ? $studenti['Mesto'] : ''; ?>
                                    </p>
                                </div>
                                <div class="form-group"><label><b>Telefónne číslo:</b></label>
                                    <p>
                                        <?php echo !empty($studenti['Telefon']) ? $studenti['Telefon'] : ''; ?>
                                    </p>
                                </div>
                                <div class="form-group"><label><b>E-mail:</b></label>
                                    <p>
                                        <?php echo !empty($studenti['Email']) ? $studenti['Email'] : ''; ?>
                                    </p>
                                </div>
